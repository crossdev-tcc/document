...
\begin{itemize}
    \item \textbf{H1}: As ferramentas multiplataforma estão evoluídas ao ponto de apresentarem mais vantagens do que desvantagens.
        \begin{itemize}
            ...
            %  ou talvez melhor que a abordagem nativa 
        \end{itemize}
...
% Com isso, ambas as abordagens puderam ser comparadas de maneira empírica com embasamento teórico oriundo das pesquisas feitas anteriormente e espera-se, ao final deste trabalho, poder auxiliar desenvolvedores a escolher 
