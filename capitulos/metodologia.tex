...
de uso realizado e serão comparadas em cada abordagem.
...
\begin{comment}
Após a seleção das funcionalidades que serão desenvolvidas e comparadas, as mesmas deverão ser avaliadas quanto à possibilidade e complexidade de desenvolvimento em cada abordagem.

As funcionalidades serão explicadas textualmente e, em alguns casos, serão apresentados trechos de códigos comentados implementando-as. Os códigos serão minerados de repositórios públicos 
ou desenvolvidos pelos autores em ambas as abordagens de desenvolvimento. 

Serão pesquisados, primeiramente, meios de se desenvolver as funcionalidades em Ionic. Caso a funcionalidade seja passível de ser desenvolvida no Ionic, serão procurados projetos 
...
Após a análise da funcionalidade no Ionic, serão minerados ou desenvolvidos, conforme a necessidade, códigos nativos para a mesma funcionalidade e, da mesma forma, comentados, para facilitar o entendimento e 
comparação entre os códigos de cada abordagem.
\end{comment}