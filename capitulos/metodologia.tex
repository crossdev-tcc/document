...
\citeonline{bezerra_desenvolvimento_2016} também fez a implementação de um aplicativo utilizando ferramenta multiplataforma, nesse caso, PhoneGap. 
...
anos atrás, fazendo-se necessários novas avaliações do desenvolvimento multiplataforma, devido à evolução das ferramentas e \textit{frameworks} neste meio tempo.
