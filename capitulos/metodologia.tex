...
multiplataforma, e após isso, ambas as abordagens poderão ser comparadas de maneira empírica com embasamento teórico oriundo das pesquisas feitas anteriormente.

Após a conclusão do estudo de uso, será feita uma análise exploratória, descrita no Capítulo~\ref{cap:analise_exploratoria}, a fim de melhorar o embasamento para a tomada de decisão entre o desenvolvimento 
nativo e multiplataforma. Para isso serão reunidas algumas funcionalidades comuns em aplicativos móveis muito conhecidos como Facebook, Snapchat, Uber e Google Maps, por exemplo, e que não foram exploradas no estudo 
de uso realizado. Essas funcionalidades serão avaliadas quanto à possibilidade e complexidade de desenvolvimento em cada abordagem.
%Para escolher as funcionalidades, serão utilizados os seguintes critérios.........bla bla bla....... 

Com as funcionalidades selecionadas, elas serão explicadas textualmente e, em alguns casos, serão apresentados trechos de códigos comentados implementando-as. Os códigos serão minerados de repositórios públicos 
ou desenvolvidos pelos autores em ambas as abordagens de desenvolvimento. 

A partir das funcionalidades selecionadas, serão pesquisados primeiramente meios de se desenvolver as funcionalidades em Ionic. Caso a funcionalidade seja passível de ser desenvolvida no Ionic, serão procurados projetos 
de código aberto, disponibilizados no Github, ou em tutoriais \textit{on-line}, que utilizem os \textit{plugins} necessários para desenvolver a funcionalidade. Caso não sejam encontrado projetos abertos, projetos de 
demonstração serão desenvolvidos pelos autores caso haja a necessidade. Os códigos serão então entendidos e comentados. 

Após a análise da funcionalidade no Ionic, serão minerados ou desenvolvidos, conforme a necessidade, códigos nativos para a mesma 
funcionalidade e, da mesma forma, comentados, para facilitar o entendimento e comparação entre os códigos de cada abordagem.

Com isso, espera-se poder concluir qual abordagem é mais adequada para cada funcionalidade estabelecida. Os resultados serão resumidos e analisados ao final do Capítulo~\ref{cap:analise_exploratoria}.     
