...
\subsubsection{Ambiente} \label{arc-ios-env}
...
\subsubsection{Linguagens} \label{arc-ios-ling}
...
\subsection{Desenvolvimento \textit{Android}} \label{arc-android-section}

O desenvolvimento de aplicativos para \textit{Android} é mais aberto e exige menos requisitos.
...

\subsubsection{Ambiente} \label{arc-android-env}
...
\subsubsection{Linguagens} \label{arc-android-ling}
...
\subsection{Desenvolvimento \textit{Ionic}} \label{arc-android-section}
