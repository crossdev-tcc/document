...
\textit{web} como \textit{HTML}, \textit{CSS} e \textit{JavaScript} otimizadas para dispositivos móveis \cite{drifty_ionic:_2013}. 
...
no desenvolvimento dos aplicativos \cite{drifty_ionic:_2013}.
...
\begin{itemize}
    ...
    e compartilhar informações entre as duas camadas \cite{drifty_ionic_2016-4}.
    ...
    para a criação da View \cite{drifty_ionic_2016-4}.
    ...
    da controladora com os dados a serem utilizados para a criação da View e para serem mostrados para o usuário \cite{drifty_ionic_2016-4}. 
    \item \textit{App Configuration}: Nesta camada, as controladoras são ligadas às suas interfaces por meio de rotas. É possível
    também, criar rotas padrão, para o caso de não haver nenhuma rota que esteja sendo identificada o sistema não quebrar \cite{drifty_ionic_2016-4}.
    ...
    retorne um valor falso \cite{drifty_ionic_2016-4}.
\end{itemize}
