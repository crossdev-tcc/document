...
\textit{AngularJS} é um \textit{framework open source}, mantido pelo Google, que permite extender a sintaxe do \textit{HTML} para poder criar páginas \textit{web} com conteúdos dinâmicos \cite{bezerra_desenvolvimento_2016}.
...
O servidor retorna o conteúdo específico e o AngularJS apresenta o novo conteúdo inserindo-o corretamente junto com o antigo já mostrado (https://angularjs.org/).
...
Essas ferramentas são listadas a seguir com uma breve explicação do que cada uma pode fazer (http://ionicframework.com).
...
\begin{itemize}
    ...
    a experiência de usuário não seja diferente no uso de uma aplicação nativa e multiplataforma (http://ionicframework.com). 
    ...
    fazer a pré-visualização em dispositivos reais para usuários pagantes (http://ionic.io/products/creator).
    ...
    configurar o ambiente necessário para o desenvolvimento (http://play.ionic.io/). 
    ...
    \textit{Testflight} da Apple para testar aplicativos, ainda em desenvolvimento, e receber \textit{feedbacks} dos clientes e testadores que o testarem (http://view.ionic.io).
    ...
    \item \textbf{Ionic Platform}: É a plataforma \textit{on-line} do \textit{Ionic} que possui serviços de \textit{back-end} em nuvem para análise de dados de uso,
     ...
     resubmeter o aplicativo para as respectivas lojas (http://ionic.io/platform). 
