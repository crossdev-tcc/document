...
\begin{figure}[h]
  \centering
    ...
    \caption[minifarma]{ minifarma. Fonte: Elaborado pelos autores.}
	\label{fig:minifarma}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{Sistema Operacional das máquinas}: \textit{Mac OS X Yosemite};
...
\begin{itemize}
    ...
    \item \textbf{Sistema Operacional alvo do aplicativo}: \textit{iOS} 9 e \textit{Android} \textcolor{red}{4.4.2};%API 19
...
\subsection{Experiências de Desenvolvimento} \label{sec:experienciasdev}
