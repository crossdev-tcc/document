...
cordova nao possui um por padrao, contribuidores foram criando e disonibilizando de acordo com suas necessidades
...
https://github.com/cordova-plugin-camera-preview/cordova-plugin-camera-preview, descontinuado pelo autor, 
entregue para a comunidade,
porém nao é atualizado há 8 meses. 
...
Phonegap plugin which allows the caller to customise a camera preview, including a custom button and overlaying a
 border image in each corner.
Tb descontinuado, n recebe atualizacao há 2 anos.

https://github.com/donaldp24/CanvasCameraPlugin
tb dois anos sem atualizacao
relatos de nao funcionar mais adequadamente no android

http://stackoverflow.com/questions/29755707/implement-camera-in-custom-page-in-cordova-ios
...
O Scanbot é um exemplo de SDK que pode ser utilizado junto ao cordova e possibilita detecção de documentos e de faces em tempo real,
 porém não é totalmente compatível com iOS e não é uma ferramenta gratuita. %\cite{gmbh_javascript_2016}
