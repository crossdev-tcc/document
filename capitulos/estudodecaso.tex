...
Foi realizado um estudo de caso para comparar o desenvolvimento de aplicações móveis utilizando ferramentas nativas e multiplataformas. Para isso, um aplicativo feito em iOS 
...
No entanto, os integrantes não possuiam qualquer conhecimento prévio nos \textit{frameworks} Ionic, AngularJS e Cordova
