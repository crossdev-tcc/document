...
\begin{figure}[H]
	...
	\caption[Trecho de código para leitura de pressão no toque - iOS]{Trecho de código para leitura de pressão no toque - iOS}
...
\begin{figure}[H]
	...
	\caption[Trecho de código para leitura de pressão no toque - Ionic]{Trecho de código para leitura de pressão no toque - Ionic}
