...
\textcolor{red}{nao é possivel debugar o ios pelo terminal, por causa da atualizacao do ios 9, 
por isso é necessario do xcode ou do safari, ou seja um mac}
...
\textcolor{red}{possibilidade de debugar com os navegadores}
...
\textcolor{red}{datepicker para selecionar, dificuldades, diferencas}
\textcolor{red}{problemas na hora de executar no iphone}
