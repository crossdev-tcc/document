...
no caso do iOS, a liguagem de programação era o \textit{Objective-C} com a \textit{IDE Xcode} e o \textit{SDK} do iOS.
...
\begin{itemize}
    ...
    \item Desenvolver uma réplica de um aplicativo criado nativamente, para a plataforma iOS, utilizando tecnologias multiplataformas, para iOS e Android;
